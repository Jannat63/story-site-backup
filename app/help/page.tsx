    ...
    <main className="min-h-screen bg-gray-100 flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-64 bg-white border-b md:border-r p-4 md:p-6 flex md:flex-col justify-between md:min-h-screen">
        ...
        <div>
          ...
          <nav className="flex md:flex-col gap-2 md:space-y-3 text-sm overflow-x-auto">
            ...
            <a href="/" className="whitespace-nowrap px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-100">
              Home
            </a>

            <a href="/about" className="whitespace-nowrap px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-100">
              About
            </a>
      ...
      <div className="flex-1 px-4 sm:px-6 py-10 md:py-16">
        <div className="max-w-4xl mx-auto">
          ...
          {/* INTRO CARD */}
          <section className="bg-white p-5 sm:p-6 rounded-xl shadow-sm mb-6 md:mb-8">
          ...
          <section className="bg-white p-5 sm:p-6 rounded-xl shadow-sm mb-6 md:mb-8">
            ...
            <div className="space-y-5 text-sm">
              ...
              <div>
                <p className="font-semibold">How can I read a story?</p>
              ...
              <div>
                <p className="font-semibold">Are all books free?</p>
                <p className="text-gray-600 mt-1">
              ...
              <div>
                <p className="font-semibold">Why is the PDF not opening?</p>
                <p className="text-gray-600 mt-1">
              ...
              <div>
                <p className="font-semibold">Can I download the stories?</p>
                <p className="text-gray-600 mt-1">
