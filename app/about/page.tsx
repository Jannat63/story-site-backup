  ...
  return (
    <main className="min-h-screen bg-gray-100 flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-64 bg-white border-b md:border-r p-4 md:p-6 flex md:flex-col justify-between md:min-h-screen">
        ...
        <div>
          <h2 className="text-lg md:text-xl font-bold mb-4 md:mb-10">
            Ahsan's E-Book
          </h2>
          ...
          <nav className="flex md:flex-col gap-2 md:space-y-3 text-sm overflow-x-auto">
            ...
            <a
              href="/"
              className="whitespace-nowrap px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-100"
            >
              Home
            </a>

            <a className="whitespace-nowrap px-3 py-2 rounded-lg bg-black text-white">
              About
            </a>
      ...
      <div className="flex-1 px-4 sm:px-6 py-10 md:py-16">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {/* HERO */}
          <section className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 md:p-10 text-center">
            ...
            {/* TAGS */}
            <div className="flex gap-2 sm:gap-3 mt-4 text-xs text-gray-600 flex-wrap justify-center">
              <span className="bg-gray-100 px-3 py-1 rounded-full">Love Stories</span>
              <span className="bg-gray-100 px-3 py-1 rounded-full">Sad Stories</span>
              <span className="bg-gray-100 px-3 py-1 rounded-full">Romantic Stories</span>
              <span className="bg-gray-100 px-3 py-1 rounded-full">Bangla Story</span>
            </div>

            <p className="text-gray-700 mt-6 text-sm sm:text-base max-w-[650px] mx-auto leading-relaxed">
            ...
            {/* CONTACT */}
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-6 mt-6 text-sm text-gray-600">
              <a
          ...
          {/* DIVIDER */}
          <div className="mt-12 md:mt-16 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent"></div>
          ...
          <section className="mt-12 md:mt-16 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="bg-white rounded-xl border p-5 md:p-6 shadow-sm">
              <h3 className="text-base md:text-lg font-semibold mb-4">✍️ Writing Focus</h3>
            ...
            <div className="bg-white rounded-xl border p-5 md:p-6 shadow-sm">
              ...
              <p className="text-sm text-gray-700">Email: ajbmix14@gmail.com</p>
